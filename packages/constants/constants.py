...
# SNS
AUTHENTICATE_SE_SNS_NAME = "SE-AUTHENTICATE-SERVICE"
START_SE_SNS_NAME = "SE-START-SEARCH"
ACCEPTED_BLOCK_SNS_NAME = "SE-ACCEPTED-BLOCK-SERVICE"
INSTANCE_SLEEP_BLOCK_SNS_NAME = "SE-SLEEP-INSTANCE-SERVICE"
LOGS_BLOCK_SNS_NAME = "SE-LOGS-SERVICE"

# SQS
SE_START_SEARCH_DEAD_LETTER_QUEUE = "SE-START-SEARCH-DLQ"
SE_AUTHENTICATE_DEAD_LETTER_QUEUE = "SE-AUTHENTICATE-DLQ"
INSTANCE_SLEEP_DEAD_LETTER_QUEUE = "INSTANCE-SLEEP-DLQ"
BLOCK_CAPTURED_DEAD_LETTER_QUEUE = "CB-DLQ"
LOGS_DEAD_LETTER_QUEUE = "LOGS-DLQ"
